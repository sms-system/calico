...
| BPFEnforceRPF                      / <br/> FELIX_BPFENFORCERPF                        | Enforce RPF on all host interfaces with BPF programs regardless of what is the per-interfaces or global setting. | Disabled,Strict,Loose | Strict |
